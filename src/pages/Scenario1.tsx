  ...
  return <div className="min-h-screen bg-black text-white relative">
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen py-24 md:py-48 flex items-center justify-center">
          <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16">
            <div className="max-w-7xl mx-auto text-center">
              <h1 className="text-4xl md:text-7xl font-bold tracking-tight mb-8 text-white">Limiting Warming to Well Below 2°C</h1>
        ...
        <section className="min-h-screen py-24 md:py-48 flex items-center justify-center">
          <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-8 text-center">What Happened during the last 25 Years </h2>
              <div className="max-w-5xl mx-auto">
                <p className="text-xl md:text-2xl lg:text-3xl leading-relaxed text-white text-justify">
        ...
        <section className="min-h-screen py-24 md:py-48 flex items-center justify-center">
          <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16">
            <div className="max-w-7xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-8 text-center lg:text-6xl">The Sound of the Ocean Sonified</h2>
