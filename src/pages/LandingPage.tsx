        ...
        <div className="relative h-screen w-full overflow-hidden bg-black">
          ...
          <div className="relative z-10 h-full flex items-center justify-between" style={{
            ...
            <div className="max-w-4xl lg:max-w-2xl">
              ...
              {/* Button with headphones note */}
              <Button onClick={handleStart} variant="pacific" size="pacific">
                START THE GAME
              </Button>
              
              <p className="text-white/80 mt-4" style={{
                fontFamily: 'Space Grotesk, sans-serif',
          ...
          {/* Scroll indicator */}
          <div 
            className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white/60 flex flex-col items-center cursor-pointer"
