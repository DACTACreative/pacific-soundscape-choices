...
Each answer directly impacts one thematic but can also contribute to others—that's the magic we often miss when measuring **impact**: **TIME**. After each answer, you'll be projected directly into the **grounded reality** of your decision by hearing the **story and impact** it has on someone's life.`,
    ...
    },
    {
      id: 5,
      title: "",
      content: `"Will you stay on track with the Blue Pacific thematics, or will you prioritize one decision above another? Will you be able to identify the outcomes they support and their potential ripple effects on others?"`,
      image: null,
      imageAlt: "",
      imageLeft: false,
      isPunchyQuote: true
      ...
      {sections.map((section, index) => (
        ...
        >
          <div className="max-w-7xl mx-auto px-8">
            {/* Special handling for punchy quote */}
            {section.isPunchyQuote ? (
              <div className="flex justify-center items-center min-h-[60vh]">
                <div className="max-w-5xl mx-8">
                  <div 
                    className="text-3xl md:text-4xl lg:text-5xl font-bold text-center text-white leading-tight"
                    style={{
              ...
              <div className="grid grid-cols-1 lg:grid-cols-10 gap-8 items-center min-h-[80vh]">
                ...
                >
                  ...
                  <div 
                    className="text-lg md:text-xl lg:text-2xl leading-relaxed text-white/90 whitespace-pre-line"
                    style={{
                      fontFamily: 'Space Grotesk, sans-serif',
